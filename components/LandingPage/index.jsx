...
function LandingPage(props) {
  ...
  const baseURL =
    "https://us-central1-burner-manchoud1.cloudfunctions.net/bbbhackathon";
    ...
    <div className="container-center-horizontal">
      <div className="landing-page screen">
        ...
        >
          ...
          <div className="customer-id jost-bold-big-stone-24px">
            {customerId}
          </div>
          <input
            className="customer-id-1"
            name="customerid"
          ...
          />
          <button
            className="login jost-bold-big-stone-24px"
